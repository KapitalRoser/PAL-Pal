...
public:
  explicit SwitchBackground(QWidget* parent = nullptr, QColor color = QColor(0, 0, 0), bool rect = false);
...
public:
  explicit SwitchCircle(QWidget* parent = nullptr, QColor color = QColor(0, 0, 0), bool rect = false);
