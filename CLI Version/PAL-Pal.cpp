...
Quiet,Bashful,Rash,Calm,Gentle,Sassy,Careful,Quirky}; //Likely don't need this anymore.
...
void writeReqsConfig(PokemonRequirements&inputReqs, std::string version){
...
PokemonRequirements setPokeReqs(std::string version){
